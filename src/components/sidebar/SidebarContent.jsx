...
import logoDark from "@/assets/img/logo-3.jpg";
import logoLight from "@/assets/img/logo-3.jpg";
  ...
  return (
    <div className="py-4 text-gray-500 dark:text-gray-400">
      <a className=" text-gray-900 dark:text-gray-200" href="/dashboard">
        {mode === "dark" ? (
          <img src={logoLight} alt="Playforia" width="205" className="pl-6" />
        ) : (
          <img src={logoDark} alt="Playforia" width="205" className="pl-6" />
        )}
      </a>
      <ul className="mt-8">
        {sidebar.map((route) =>
