...
import UserRestrictDrawer from "@/components/drawer/UserRestrictDrawer";
          ...
          <Table>
            <TableHeader>
              <tr>
                ...
                {/* <TableCell className="text-center">{t("restrict")}</TableCell> */}
                {/* <TableCell className="text-center">
                  {t("PublishedTbl")}
                </TableCell> */}
            ...
            <StaffTable staffs={data.data} lang={lang} />
          </Table>
          {/* <TableFooter>
            <Pagination
