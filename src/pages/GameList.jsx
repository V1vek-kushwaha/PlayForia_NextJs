...
const GameList = () => {
  ...
  const { data, loading, error } = useAsync(() => AdminServices.getAllGames());
  console.log("game lisr", data);
  ...
  return (
    <>
      <PageTitle>{t("All Games List")} </PageTitle>
      {/* <MainDrawer>
        <StaffDrawer />
      </MainDrawer> */}
      ...
      {loading ? (
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          <Table>
            ...
            <GamesTable data={data} lang={lang} />
          </Table>
          {/* <TableFooter>
              <Pagination
        ...
        <NotFound title="Sorry, There are no Games." />
      )}
    </>
  );
};
