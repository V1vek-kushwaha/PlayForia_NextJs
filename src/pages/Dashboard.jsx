    ...
    <>
      ...
      <AnimatedContent>
        <div className="grid gap-2 mb-8 xl:grid-cols-5 md:grid-cols-2">
          <CardItemTwo
            mode={mode}
            title="Total live user"
            title2="Total live user"
            Icon={ImStack}
          ...
          <CardItemTwo
            mode={mode}
            title="Yesterday live user"
            title2="Yesterday live user"
            Icon={ImStack}
